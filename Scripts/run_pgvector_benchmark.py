#!/usr/bin/env python3
"""
Complete end-to-end benchmark for Pgvector.
...
def main():
    ...
    print(f"Collection: {CONFIG['pgvector_config']['table_name']}")
    ...
    try:
        ...
        print(f"\n❌ Failed to connect to Pgvector: {e}")
        print("\nMake sure Pgvector is running:")
        print("  docker-compose up -d pgvector")
        print("or:")
        print("  docker-compose up -d pgvector")
        return 1
    ...
    try:
        ...
        print(f"✅ Collection '{CONFIG['pgvector_config']['table_name']}' created")
    except Exception as e:
