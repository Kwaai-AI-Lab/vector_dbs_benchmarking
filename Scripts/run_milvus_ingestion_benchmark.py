...
Mirrors the ingestion workflow used for Chroma.
"""
...
CONFIG = {
    ...
    'milvus_config': {
        ...
        'collection_name': 'IngestionBenchmark',
        'index_type': 'IVF_FLAT',
        'metric_type': 'L2',
        'nlist': 128
    },
...
def main():
    ...
    print("\n" + "="*70)
    print("INGESTION BENCHMARK COMPLETE (Milvus)")
    print("="*70)
    print(f"\n📁 Results: {output_dir}")
...
def generate_plots(df: pd.DataFrame, output_dir: Path):
    ...
    ax2.set_ylabel('Number of Chunks Created')
