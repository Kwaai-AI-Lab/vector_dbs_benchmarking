#!/usr/bin/env python3
"""
Ingestion performance benchmark for pgvector (PostgreSQL).
Mirrors the Qdrant ingestion workflow and writes artifacts to the results folder.
"""
...
CONFIG = {
    ...
    'pg_config': {
        ...
        'user': 'postgres',
        'password': 'postgres',
        'table_name': 'ingestion_benchmark',
        'index_type': 'ivfflat',
        'lists': 100
    },
    ...
    # Simplified experiment parameters for speed
...
def main():
    """Run comprehensive ingestion benchmark for pgvector."""

    print("="*70)
    print("pgvector Ingestion Performance Benchmark")
    print("="*70)
    ...
    # Initialize pgvector
    print("\n[4/6] Connecting to PostgreSQL (pgvector)...")
    benchmark = PgvectorRAGBenchmark(
    ...
    # Print summary
    print("\n" + "="*70)
    print("INGESTION BENCHMARK COMPLETE (pgvector)")
    print("="*70)
    ...
    print(f"\n🏆 Fastest total time: chunk_size={fastest['chunk_size']}, "
