...
| **PGVector (HNSW)** | **~0.00** | Constant time, warm-up effect | 9.9 - 11.0 ms |
...
|----------|----------------|-------------------|---------------|
| Chroma, Qdrant, Weaviate, Milvus | **Cosine distance** | `sim = 1 - distance` | Text embeddings (semantic) |
